 ...
 */
class PoecomViewOptions extends JView {
    ...
    protected function addToolBar() {
        JLoader::register('OptionsHelper', JPATH_COMPONENT_ADMINISTRATOR . '/helpers/options.php');

        OptionsHelper::addSubmenu('options');

        $canDo = OptionsHelper::getActions();

        JToolBarHelper::title(JText::_('COM_POECOM_MANAGER_OPTIONS'), 'options');
