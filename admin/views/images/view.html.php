 ...
 * Product Images View
 */
class PoecomViewImages extends JView{
	...
	{
        JLoader::register('ImagesHelper', JPATH_COMPONENT_ADMINISTRATOR.'/helpers/images.php');
        
        ImagesHelper::addSubmenu('images');
		
        $canDo = ImagesHelper::getActions();
       
		JToolBarHelper::title(JText::_('COM_POECOM_MANAGER_IMAGES'), 'images');
