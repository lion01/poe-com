...
<div style="float: left;">
    ...
    <form action="" method="post" name="adminForm" id="option-form">
            ...
            <fieldset class="adminform">
                ...
                <ul class="adminformlist">
                    ...
                    foreach ($this->form->getFieldset('details') as $field) {
                        if ( $field->id != 'jform_product_id' && $field->id != 'jform_dom_element' ) {
        ...
        <div>
            <input type="hidden" id="product_id" value="<?php echo $this->product_id; ?>" />
            <input type="hidden" id="option_id" value="<?php echo $this->option_id; ?>" />
            <?php echo JHtml::_('form.token'); ?>
        </div>
    </form>
</div>
<script src="<?php echo JURI::root() . 'administrator/components/com_poecom/models/forms/modal.productoption.js'; ?>"></script>