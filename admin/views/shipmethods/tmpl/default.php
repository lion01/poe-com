...
<form action="<?php echo JRoute::_('index.php?option=com_poecom'); ?>" method="post" name="adminForm" id="adminForm">
    <fieldset id="filter-bar">
        <div class="filter-search fltlft">
            ...
            <input type="text" name="filter_search" id="filter_search" value="<?php echo $this->escape($this->state->get('filter.search')); ?>" title="<?php echo JText::_('COM_POECOM_SHIPMETHODS_FILTER_SEARCH_DESC'); ?>" />
    ...
    <table class="adminlist">
        <thead>
        	...
        	<th>
        		<?php echo JText::_('COM_POECOM_SHIPMETHOD_HEADING_NAME'); ?>
        	</th>
            <th>
        		<?php echo JText::_('COM_POECOM_SHIPMETHOD_HEADING_LOGO'); ?>
        	</th>
             <th>
        		<?php echo JText::_('COM_POECOM_SHIPMETHOD_HEADING_PLUGIN'); ?>
        	</th>
            <th>
        ...
        <tbody>
            ...
            if($this->items){ 
            	...
            	<tr class="row<?php echo $i % 2; ?>">
                    ...
                    <td>
                        <a href="index.php?option=com_poecom&view=shipmethod&task=shipmethod.edit&id=<?php echo $item->id; ?>"><?php echo $item->name; ?></a>
                    </td>
                    <td>
                        <?php echo $item->logo; ?>
                    </td>
                    ...
                    <td>
                        <?php echo $item->sm_default == 1?JText::_('JYes'):''; ?>
                    </td>
                    <td>
    ...
    <div>
        ...
        <input type="hidden" name="view" value="shipmethods" />
