 ...
 * Coupon View
 */
class PoecomViewCoupon extends JView{
    /**
    * View form
    *
    * @var form
    ...
    */
    protected function addToolBar(){
        JLoader::register('CouponHelper', JPATH_COMPONENT_ADMINISTRATOR.'/helpers/coupon.php');
        JRequest::setVar('hidemainmenu', true);
      
        $isNew = $this->item->id == 0;
        $canDo = CouponHelper::getActions($this->item->id);
        
        // Set title and icon class
        JToolBarHelper::title($isNew ? JText::_('COM_POECOM_COUPON_NEW') : JText::_('COM_POECOM_COUPON_EDIT'), 'coupon');
    ...
    */
    protected function setDocument(){
        ...
        $document->addScript(JURI::root() . "/administrator/components/com_poecom/views/coupon/submitbutton.js");
