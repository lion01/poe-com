...
<div class="width-100 fltlft">
    <fieldset class="adminform">
         <legend><?php echo JText::_('COM_POECOM_FLYER_DETAILS'); ?></legend>
         <form action="index.php?option=com_poecom&layout=edit&id=<?php echo $this->item->id; ?>" method="post" name="adminForm" id="flyer-form" class="form-validate">
...
<div id="section_list" class="width-60 fltlft">
    <fieldset class="adminform">
        <legend><?php echo JText::_('COM_POECOM_FLYER_SECTIONS'); ?></legend>
        <div id="sections">
        </div>
    </fieldset>
</div>
<div id="hmodal">
    <a class="flyermodal" id="modalPOEcom" rel="{handler: 'iframe', size: {x: 550, y: 600}}" 
