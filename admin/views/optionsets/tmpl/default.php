...
<form action="index.php?option=com_poecom" method="post" name="adminForm" id="adminForm">
    ...
    <table class="adminlist">
        <thead>
            <tr>
                ...
                <th>
                    <?php echo JText::_('COM_POECOM_OPTIONSET_HD_NAME'); ?>
                </th>
                <th>
                    <?php echo JText::_('COM_POECOM_OPTIONSET_HD_OPTIONS'); ?>
                </th>
                <th>
            ...
            if ($this->items) {
                foreach ($this->items as $i => $item) {
                    ...
                    <tr class="row<?php echo $i % 2; ?>">
                        ...
                        <td>
                            <a href="index.php?option=com_poecom&view=optionset&task=optionset.edit&id=<?php echo $item->id; ?>"><?php echo $item->name; ?></a>
                        </td>
                        <td>
                            <?php if(!empty($item->options)){
                                foreach($item->options as $op){
                                    echo $op->name . ' : ' . $op->type_name . '<br/>';
                                }
                            } ?>
                        </td>
                        <td>
    ...
    <div>
        ...
        <input type="hidden" name="view" value="optionssets" />
