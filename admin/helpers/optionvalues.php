...
/**
 * Product Option Values helper.
 */
abstract class OptionValuesHelper {
    ...
    public static function addSubmenu($submenu) {
        ...
        $document->addStyleDeclaration('.icon-48-optionvalues {background-image: url(../media/com_poecom/images/icon-48-optionvalues.png);}');
    }

    /**
     * Get the actions
     */
    public static function getActions($optionValueId = 0) {
        ...
        if (empty($optionId)) {
            ...
            $assetName = 'com_poecom.name.' . (int) $optionValueId;
        }
