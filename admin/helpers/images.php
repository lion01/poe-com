...
abstract class ImagesHelper {
    ...
    public static function addSubmenu($submenu) {
        ...
        $document->addStyleDeclaration('.icon-48-images {background-image: url(../media/com_poecom/images/icon-48-images.png);}');
    }

    /**
     * Get the actions
     */
    public static function getActions($imageId = 0) {
        ...
        if (empty($imageId)) {
            ...
            $assetName = 'com_poecom.name.' . (int) $imageId;
        }
