...
/**
 * Product RelatedProducts helper.
 */
abstract class RelatedProductsHelper {
    ...
    public static function addSubmenu($submenu) {
        ...
        JSubMenuHelper::addEntry(JText::_('COM_POECOM_SUBMENU_RELATED_GROUPS'), 'index.php?option=com_poecom&view=relatedgroups', $submenu == 'relatedgroups');
        ...
        $document->addStyleDeclaration('.icon-48-relatedproducts {background-image: url(../media/com_poecom/images/icon-48-relatedproducts.png);}');
    }

    /**
     * Get the actions
     */
    public static function getActions($relatedProductId = 0) {
        ...
        if (empty($relatedProductId)) {
            ...
            $assetName = 'com_poecom.name.' . (int) $relatedProductId;
        }
