...
/**
 * OptionSet RAW Controller
 */
class PoecomControllerOptionSet extends JController{
    ...
    public function getOptions(){
        ...
        if(!empty($id)){
            $model = JModel::getInstance('OptionSet', 'PoecomModel');
            $optionset_options = $model->getOptions($id);
            
            if($optionset_options){
...
<ul id="optionset_option_list">';
                foreach($optionset_options as $op){
                    $html .= '<li>';
