 ...
 */
class PoecomControllerPayTransactions extends JControllerAdmin{
    ...
    * @since	1.6
    */
    public function getModel($name = 'PayTransactions', $prefix = 'PoecomModel'){
    ...
    */
    public function delete(){
        ...
        if (!is_array($cids) || count($cids) < 1){
            ...
            // Get the model.
            $model = $this->getModel('PayTransaction');
