 ...
 * Location Model
 */
class PoecomModelLocation extends JModelAdmin{
    /**
    ...
    */
    public function getForm($data = array(), $loadData = true){
        // Get the form.
        $form = $this->loadForm('com_poecom.location', 'location', array('control' => 'jform', 'load_data' => $loadData));
        if (empty($form)){
            return false;
        }
        return $form;
    ...
    */
    public function getScript(){
        return JURI::root(true).'/administrator/components/com_poecom/models/forms/location.js';
    }
    ...
    */
    protected function loadFormData(){
        ...
        $data = JFactory::getApplication()->getUserState('com_poecom.location.edit.data', array());
        if (empty($data)){
                $data = $this->getItem();
        }
        return $data;
    ...
    */
     ...
     * 
     * @param array $cids List of Location ids to delete
     */
