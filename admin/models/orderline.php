 ...
 * Order Model
 */
class PoecomModelOrderLine extends JModelAdmin{
    /**
    ...
    * @since	1.6
    */
    public function getTable($type = 'OrderLine', $prefix = 'PoecomTable', $config = array()){
    ...
    */
    public function getForm($data = array(), $loadData = true){
        // Get the form.
        $form = $this->loadForm('com_poecom.order', 'orderline', array('control' => 'jform', 'load_data' => $loadData));
        if (empty($form)){
            return false;
        }
        return $form;
    ...
    */
    public function getScript(){
        return JURI::root(true).'/administrator/components/com_poecom/models/forms/orderline.js';
    }
    ...
    */
    protected function loadFormData(){
        ...
        $data = JFactory::getApplication()->getUserState('com_poecom.orderline.edit.data', array());
        if (empty($data)){
            $data = $this->getItem();
        }
        return $data;
    ...
    */
    ...
    /**
     * Check if product id used in order lines
     * 
     * Delete validation
     * 
