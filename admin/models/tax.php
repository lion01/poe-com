 ...
 * Tax Model
 */
class PoecomModelTax extends JModelAdmin{
    /**
    ...
    */
    public function getForm($data = array(), $loadData = true){
        // Get the form.
        $form = $this->loadForm('com_poecom.tax', 'tax', array('control' => 'jform', 'load_data' => $loadData));
        if (empty($form)){
            return false;
        }
        return $form;
    ...
    */
    protected function loadFormData(){
        ...
        $data = JFactory::getApplication()->getUserState('com_poecom.tax.edit.data', array());
        if (empty($data)){
                $data = $this->getItem();
        }
        return $data;
    ...
    */
     ...
     * 
     * @param array $cids List of Tax ids to delete
     */
    public function delete(&$cids){
        if($cids){
            ...
            /* TODO: add tax check in orders and RFQs
            foreach($cids as $cid){
                //check status
