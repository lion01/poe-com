 ...
 * Flyer Model
 */
class PoecomModelFlyer extends JModelAdmin {
    ...
    */
    public function getScript(){
        $file = JPATH_ADMINISTRATOR.'/components/com_poecom/models/forms/flyer.js';
 
        if(JFile::exists($file)){
            $js = JURI::root(true).'/administrator/components/com_poecom/models/forms/flyer.js';
        }else{
            $js = '';
        }
    ...
    public function getForm($data = array(), $loadData = true) {
        // Get the form.
        $form = $this->loadForm('com_poecom.flyer', 'flyer', array('control' => 'jform', 'load_data' => $loadData));
        if (empty($form)) {
            return false;
        }
        return $form;
    ...
    protected function loadFormData() {
        ...
        $data = JFactory::getApplication()->getUserState('com_poecom.flyer.edit.data', array());
        if (empty($data)) {
            $data = $this->getItem();
        }
        return $data;
