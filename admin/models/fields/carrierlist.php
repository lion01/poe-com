...
/**
 * Form Field class for Shipping Carrier List
 *
 * @package     Joomla.Platform
 * @subpackage  Form
 * @since       11.1
 */
class JFormFieldCarrierList extends JFormFieldList{
    /**
    * The form field type.
    *
    * @var    string
    ...
    */
	...
	$options_list = array();
        ...
        $query->from('#__poe_shipping_method');
        ...
        $options_list[] = JHtml::_('select.option', 0, '--Select Carrier--');
