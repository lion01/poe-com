...
/**
 * Form Field class for Coupon Status
 *
 * @package     Joomla.Platform
 * @subpackage  Form
 * @since       11.1
 */
class JFormFieldCouponStatusList extends JFormFieldList{
    /**
    * The form field type.
    *
    * @var    string
    * @since  11.1
    */
    protected $type = 'CouponStatusList';
    ...
    */
	...
	$options_list = array();
        ...
        $query->from('#__poe_coupon_status');
