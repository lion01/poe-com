...
/**
 * Form Field class for Promotion Types
 *
 * @package     Joomla.Platform
 * @subpackage  Form
 * @since       11.1
 */
class JFormFieldPromotionTypeList extends JFormFieldList{
    /**
    * The form field type.
    *
    * @var    string
    * @since  11.1
    */
    protected $type = 'PromotionTypeList';
    ...
    */
	...
	$options_list = array();
        ...
        $query->from('#__poe_promotion_type');
