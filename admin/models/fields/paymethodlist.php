...
/**
 * Form Field class for Payment Methods
 *
 * @package     Joomla.Platform
 * @subpackage  Form
 * @since       11.1
 */
class JFormFieldPayMethodList extends JFormFieldList{
    /**
    * The form field type.
    *
    * @var    string
    ...
    */
    protected function getOptions(){
        ...
        $query->from('#__poe_payment_method');
        ...
        $options_list[] = JHtml::_('select.option', 0, '--Select Method--');
