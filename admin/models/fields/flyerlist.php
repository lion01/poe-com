...
/**
 * Form Field class for Flyer List
 *
 * @package     Joomla.Platform
 * @subpackage  Form
 * @since       11.1
 */
class JFormFieldFlyerList extends JFormFieldList{
    /**
    * The form field type.
    *
    * @var    string
    ...
    */
	...
	$options_list = array();
        ...
        $options_list[] = JHtml::_('select.option', 0, '--Select Flyer--');
