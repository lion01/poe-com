...
/**
 * Form Field class for Promotion Discount Types
 *
 * @package     Joomla.Platform
 * @subpackage  Form
 * @since       11.1
 */
class JFormFieldDiscountTypeList extends JFormFieldList{
    /**
    * The form field type.
    *
    * @var    string
    * @since  11.1
    */
    protected $type = 'DiscountTypeList';
    ...
    */
	...
	$options_list = array();
        ...
        $query->from('#__poe_discount_type');
