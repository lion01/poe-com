...
/**
 * Form Field class for Promotion Discount Amount Types
 *
 * @package     Joomla.Platform
 * @subpackage  Form
 * @since       11.1
 */
class JFormFieldDiscountAmountTypeList extends JFormFieldList{
    /**
    * The form field type.
    *
    * @var    string
    * @since  11.1
    */
    protected $type = 'DiscountAmountTypeList';
    ...
    */
	...
	$options_list = array();
        ...
        $query->from('#__poe_discount_amount_type');
