...
/**
 * Form Field class for Payment Transaction Status
 *
 * @package     Joomla.Platform
 * @subpackage  Form
 * @since       11.1
 */
class JFormFieldPayTransactionStatusList extends JFormFieldList{
    /**
    * The form field type.
    *
    * @var    string
    * @since  11.1
    */
    protected $type = 'PayTransactionStatusList';
    ...
    */
    protected function getOptions(){
        ...
        $query->from('#__poe_payment_status');
        ...
        $options_list[] = JHtml::_('select.option', 0, '--Select Status--');
