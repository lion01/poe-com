 ...
 * @since       11.1
 */
class JFormFieldCreditCardList extends JFormFieldList{
    /**
    * The form field type.
    *
    * @var    string
    ...
    */
    ...
    /**
    * Over ride method to get the field options for credit cards
    *
    ...
    */
    protected function getOptions(){
        ...
        $db = JFactory::getDBO();
        $q = $db->getQuery(true);
		$q->select('code as value,name as text' );
